...
func (sao *ViewAccessOperator) Create(teamId uuid.UUID, name string, levels *pq.StringArray, sources *pq.StringArray, date *models.DateInterval, jobId string) (*schema.View, error) {
	dbView := schema.View{
		TeamId: teamId,
		Name:   name,
		JobId:  jobId,
