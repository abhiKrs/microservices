...
lazy val dependencies =
  new {
    ...
    val akkaCors            = "ch.megard"                  %% "akka-http-cors"        % "1.2.0"
    val grpcCors            = "com.github.dnvriend"        %% "grpc-cors"             % "0.15.0"

    //    TEST
    val scalaTest               = "org.scalatest"                 %% "scalatest"                      % "3.2.9"
    val flinkTestUtils          = "org.apache.flink"              % "flink-test-utils"                % flinkVersion
    val flinkTestUtilsJunit     = "org.apache.flink"              % "flink-test-utils-junit"          % flinkVersion
    val flinkStreamingJavaTest  = "org.apache.flink"              % "flink-streaming-java"            % flinkVersion % Test classifier "tests"
...
val extraDependenciesFromFlink = Seq(
  ...
  dependencies.flinkStreamingJavaTest,
)
...
val flowTestDeps = Seq(
  ...
  dependencies.flinkTestUtilsJunit,
